    ...
    >
      <div>
        ...
        <p className="text-justify leading-loose text-[#c4c4c4]">
          ...
          background, holding a Higher National Diploma (HND) from Lagos State
          Polytechnic. With several years of valuable experience in the fintech
          industry, I have developed a deep understanding of building
          cutting-edge fintech products. My primary expertise lies in using
