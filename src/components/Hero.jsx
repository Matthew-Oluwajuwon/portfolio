...
const Hero = () => {
  return (
    <div
      ...
      // data-aos="fade-up"
    >
      <div className="absolute inset-0 top-[7rem] 3xl:top-[120px] xl:mt-36 px-5 lg:px-0 max-w-7xl justify-between mx-auto flex flex-wrap items-start gap-5">
        <section className="text-[2rem] lg:text-[3.6rem] font-bold text-[#f5f5f5] font-[poppins-extrabold]">
          Hi 👋, <br /> My name is <br />
          <span className="name">Matthew Oluwajuwon</span>
          <br />
